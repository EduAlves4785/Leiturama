...
HttpSession armazenaCampos= request.getSession();
armazenaCampos.setAttribute("email", email);
armazenaCampos.setAttribute("senha", senha);
armazenaCampos.setAttribute("nome", nome);
armazenaCampos.setAttribute("cpf", cpf);
      ...
      <div class="u-clearfix u-sheet u-sheet-1">
        ...
        <div class="custom-expanded u-container-style u-gradient u-group u-radius-50 u-shape-round u-similar-fill u-group-1" data-animation-name="customAnimationIn" data-animation-duration="1000" data-animation-direction="">
          <div class="u-container-layout u-container-layout-1">
            <h2 class="u-custom-font u-text u-text-default u-text-white u-text-1" data-animation-name="customAnimationIn" data-animation-duration="1000">Área de Login</h2>
            <div class="custom-expanded u-form u-form-1"> 
              <form action="ValidaLogin.jsp" method="post" class="u-form-1" style="padding: 0px;">
                <div class="u-form-group u-form-name u-label-none">
                  <label for="email" class="u-label">Email</label>
                  <input type="text" placeholder="Insira seu e-mail" id="email" name="email" class="u-input u-input-rectangle">
                </div><br>
                <div class="u-form-group u-label-none">
                  <label for="senha" class="u-label">Senha</label>
                  <input type="password" placeholder="Insira sua senha" id="senha" name="senha" class="u-input u-input-rectangle">
                </div><br>
            ...
            <img class="u-image u-image-contain u-image-default u-preserve-proportions u-image-2" src="images/image15.png" alt="" data-image-width="100" data-image-height="100">
            <img class="u-image u-image-contain u-image-default u-preserve-proportions u-image-3" src="images/image16.png" alt="" data-image-width="100" data-image-height="100">
            <h3 class="u-align-center u-custom-font u-text u-text-white u-text-2">Não tem conta ? crie uma agora!<br>clique aqui em baixo:&nbsp;
            </h3>
            <a href="Cadastro.jsp" class="u-align-center-xs u-border-none u-btn u-button-style u-gradient u-none u-text-active-custom-color-6 u-text-white u-btn-2" data-animation-name="customAnimationIn" data-animation-duration="1250">CADASTRE-SE</a>
          </div>
        </div>
        <img class="u-image u-image-contain u-image-default u-preserve-proportions u-image-4" src="images/image17.png" alt="" data-image-width="100" data-image-height="100" data-animation-name="customAnimationIn" data-animation-duration="1000">
      </div>
    </section>
